...
public class RPGManagerTest {
    @Test
    public void buySellTest() throws InsufficentCurrencyException, NonExistentObjectException{
        ...
        assertThrows(InsufficentCurrencyException.class, () -> r.buy("Leather Jacket"));
        p.grantCurrency(15);
