public class AchievementTest {
    ...
    AssertEquals(3,TestAchievement5.getID());
    AssertEquals(3,TestAchievement6.getID());
    ...
    AssertEquals("Achievement5",TestAchievement5.getTitle());
    AssertEquals("Achievement6",TestAchievement6.getTitle());
...
*/
    ...
    AssertEquals("New Achievement5"),TestAchievement5.getDescription());
    AssertEquals("New Achievement6"),TestAchievement6.getDescription());
   ...
   /*
    ...
    AssertEquals(3,TestAchievement5.getQuality());
    AssertEquals(3,TestAchievement6.getQuality());
